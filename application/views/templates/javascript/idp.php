...
function refresh_marker(map) {
    $.getJSON("<?php echo base_url();?>index.php/monitor/ajax_idp/", function(data){
        ...
        $.each(locations, function(i, location){
            if(location.status_gps=='Offline'){
                window.createNotification({
                    ...
                    title: location.nama_kapal,
                    message: 'Offline, Last Poll '+location.waktu_lokal
                })
            ...
            google.maps.event.addListener(marker, 'click', (function(marker, i) {
                return function() {
                  $('#exampleModal').on('show.bs.modal', function (event) {
                    ...
                    var lastpoll = location.waktu_lokal
                    var speed = location.speed+' Knot'
